...
// ... (keep existing blog data and middleware setup)
...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      let imageUrl =
        "https://res.cloudinary.com/your-cloud-name/image/upload/v1/blog-images/default-image.jpg"; // Your default image URL
...
app.post(
  ...
  async (req, res) => {
    try {
      ...
      let imageUrl = blogs[index].imageUrl;
